...
function getLangFileName($langName)
{
	...
	$langArr["Chinese (Taiwan)"] = "Taiwan";
	$langArr["Czech"] = "Czech";
	$langArr["Danish"] = "Danish";
	$langArr["Dutch"] = "Dutch";
	$langArr["English"] = "English";
	$langArr["French"] = "French";
	$langArr["German"] = "German";
	$langArr["Hebrew"] = "Hebrew";
...
function GetUserPermissionsStatic( $table )
{
	...
	if($table=="clientes" && $sUserGroup=="<Guest>")
	{
			return "S".$extraPerm;
	}
//	default permissions
	...
	if($table=="user" && $sUserGroup=="<Guest>")
	{
			// guest sees nothing
		return "";
	}
...
function SetLangVars($xt, $prefix, $pageName = "", $extraparams = "")
{
	...
	$xt->assign("Chinese (Taiwan)LANGLINK", "Chinese (Taiwan)" != $currentLang);
	$xt->assign("CzechLANGLINK", "Czech" != $currentLang);
	$xt->assign("DanishLANGLINK", "Danish" != $currentLang);
	...
	$xt->assign("HebrewLANGLINK", "Hebrew" != $currentLang);
...
function getDefaultLanguage()
{
	if( strlen($_SESSION["language"]) == 0 && $_SERVER['HTTP_ACCEPT_LANGUAGE'] )
	{
		...
		$arrWizardLang[] = "Chinese (Taiwan)";
		$arrWizardLang[] = "Czech";
		$arrWizardLang[] = "Danish";
		$arrWizardLang[] = "Dutch";
		$arrWizardLang[] = "English";
		$arrWizardLang[] = "French";
		$arrWizardLang[] = "German";
		$arrWizardLang[] = "Hebrew";
