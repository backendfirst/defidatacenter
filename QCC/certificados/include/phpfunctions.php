...
function runner_mail_smtp($params)
{
	...
	if ("0" == "1" && "sistemas@qcc.com.mx"!="" || isset($params['username']))
	{
		$mail->SMTPAuth   = true;                  				// enable SMTP authentication
		$mail->Username   = isset($params['username']) ? $params['username'] : "sistemas@qcc.com.mx";  		// SMTP username
		$mail->Password   = isset($params['password']) ? $params['password'] : "123sistemas123";   // SMTP password
	}else{
		$mail->SMTPAuth = false;
	}
	if("0" == "1" && "qcc.com.mx" != "" || isset($params['host']))
	{
		$mail->Host = isset($params['host']) ? $params['host'] : "qcc.com.mx";     // sets SMTP server
	}
