...
class tDAL
{
	var $tblqcc_at_localhost__clientes;
	var $tblqcc_at_localhost__qcc_audit;
	var $tblqcc_at_localhost__qcc_locking;
	var $tblqcc_at_localhost__qcc_uggroups;
	var $tblqcc_at_localhost__qcc_ugmembers;
	var $tblqcc_at_localhost__qcc_ugrights;
	var $tblqcc_at_localhost__user;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "clientes", "varname" => "qcc_at_localhost__clientes", "altvarname" => "clientes", "connId" => "qcc_at_localhost", "schema" => "", "connName" => "qcc at localhost");
		$this->lstTables[] = array("name" => "qcc_audit", "varname" => "qcc_at_localhost__qcc_audit", "altvarname" => "qcc_audit", "connId" => "qcc_at_localhost", "schema" => "", "connName" => "qcc at localhost");
		$this->lstTables[] = array("name" => "qcc_locking", "varname" => "qcc_at_localhost__qcc_locking", "altvarname" => "qcc_locking", "connId" => "qcc_at_localhost", "schema" => "", "connName" => "qcc at localhost");
		$this->lstTables[] = array("name" => "qcc_uggroups", "varname" => "qcc_at_localhost__qcc_uggroups", "altvarname" => "qcc_uggroups", "connId" => "qcc_at_localhost", "schema" => "", "connName" => "qcc at localhost");
		$this->lstTables[] = array("name" => "qcc_ugmembers", "varname" => "qcc_at_localhost__qcc_ugmembers", "altvarname" => "qcc_ugmembers", "connId" => "qcc_at_localhost", "schema" => "", "connName" => "qcc at localhost");
		$this->lstTables[] = array("name" => "qcc_ugrights", "varname" => "qcc_at_localhost__qcc_ugrights", "altvarname" => "qcc_ugrights", "connId" => "qcc_at_localhost", "schema" => "", "connName" => "qcc at localhost");
		$this->lstTables[] = array("name" => "user", "varname" => "qcc_at_localhost__user", "altvarname" => "user", "connId" => "qcc_at_localhost", "schema" => "", "connName" => "qcc at localhost");
	}
