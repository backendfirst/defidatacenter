...
class RightsPage extends ListPage
{
	...
	function fillGroupsArr()
	{
		...
		$sql = "select ". $grConnection->addFieldWrappers( "GroupID" ) .", ". $grConnection->addFieldWrappers( "Label" )
			." from ". $grConnection->addTableWrappers( "qcc_uggroups" ) ." order by ". $grConnection->addFieldWrappers( "Label" );
	...
	function getRights()
	{
		...
		$sql = "select ". $this->connection->addFieldWrappers( "GroupID" )
			...
			." from ". $this->connection->addTableWrappers( "qcc_ugrights" )
...
//				continue;
	...
	{
		$rightWTableName = $this->connection->addTableWrappers( "qcc_ugrights" );
