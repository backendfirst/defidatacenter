...
class ConnectionManager
{
	...
	{
		return $this->byId( "qcc_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "qcc_at_localhost";
		$data["connName"] = "qcc at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;qcc;QCC-2018-CDMX;;qcc;;1"; //currently unused
		
		$this->_connectionsIdByName["qcc at localhost"] = "qcc_at_localhost";
		
		$data["connInfo"] = array();
		$data["ODBCUID"] = "qcc";
		$data["ODBCPWD"] = "QCC-2018-CDMX";
		$data["leftWrap"] = "`";
		$data["rightWrap"] = "`";
		...
		$data["connInfo"][1] = "qcc";
		$data["connInfo"][2] = "QCC-2018-CDMX";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "qcc";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=qcc;Pwd=QCC-2018-CDMX;Database=qcc;OPTION=3";
		// encription set
		...
		$connectionsData["qcc_at_localhost"] = $data;
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["clientes"] = "qcc_at_localhost";
		$connectionsIds["user"] = "qcc_at_localhost";
