...
$servidor="localhost";
$usuariodb="asuntosr_qcc";
$passworddb="QCC-2018-CDMX";
$basededatos="asuntosr_qcc";
mysql_connect($servidor,$usuariodb,$passworddb);
// si haces conexion desde internnet usa 3 parametros si es a nivel local solo 2

mysql_select_db($basededatos);//nombre de la base de datos

if(strlen(trim($busca))>2)
	{
		$busqueda=mysql_query("SELECT * FROM clientes WHERE nombre LIKE '%".$busca."%' LIMIT 1" );
...
?>
     ...
     <h4>En caso de que no aparezca  alguna información sobre los clientes certificados, suspendidas o cancelados;les solicitamos llenar el siguiente formulario, con la información que a continuación se le solicita:</h4>
      <form class="form-inline" role="form" action="php/contacto.php" method="POST" id="contacto" title="Nombre">
        ...
        <br><div class="g-recaptcha" data-sitekey="6LeHfRUUAAAAANlXL660ziegGceWEe1z-7P_go5t"></div>
        <br>
